...
public:
    ...
    bool usesIndividualVoltageThresholds() const;
    void updateIndividualVoltageProtection();
    bool isIndividualVoltageDischargeAllowed() const;
...
private:
    ...
    enum class IndividualVoltageState : uint8_t { Unknown, Blocked, Allowed };
    IndividualVoltageState _individualVoltageState = IndividualVoltageState::Unknown;
    std::optional<uint32_t> _oLowVoltageSinceMillis = std::nullopt;
